...
@Component({
  ...
  styleUrl: './footer-instagram.component.css'
})
export class FooterInstagramComponent implements OnInit {
      constructor(private title: Title, private meta: Meta) {}

  ngOnInit(): void {
    this.title.setTitle('Follow Us on Instagram | you x 0.8');
    this.meta.addTags([
      { name: 'description', content: 'Join our Instagram for tips, updates, and inspiration.' },
