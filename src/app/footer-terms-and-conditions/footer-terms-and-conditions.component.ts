...
@Component({
  selector: 'app-footer-terms-and-conditions',
  imports: [],
  templateUrl: './footer-terms-and-conditions.component.html',
  styleUrl: './footer-terms-and-conditions.component.css'
})
export class FooterTermsAndConditionsComponent implements OnInit{
     constructor(private title: Title, private meta: Meta) {}

  ngOnInit(): void {
    this.title.setTitle('Terms & Conditions | you x 0.8');
    this.meta.addTags([
